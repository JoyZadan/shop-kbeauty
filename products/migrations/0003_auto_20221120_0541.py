# Generated by Django 3.2 on 2022-11-20 05:41
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='product',
            name='description',
            field=models.TextField(help_text='format: required, max_length=2500', max_length=2500, verbose_name='Product description'),
        ),
        migrations.AlterField(
            model_name='product',
            name='how_to_use',
            field=models.TextField(help_text='format: required, max_length=2500', max_length=2500, verbose_name='How to use'),
        ),
        migrations.AlterField(
            model_name='product',
            name='ingredients',
